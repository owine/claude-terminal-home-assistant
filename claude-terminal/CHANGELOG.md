...
* update all non-major dependencies ([#318](https://github.com/owine/claude-terminal-home-assistant/issues/318)) ([bfc8d1e](https://github.com/owine/claude-terminal-home-assistant/commit/bfc8d1e9ffc17310d55e5b4bad7a54405ccba05a))
* update all non-major dependencies ([#320](https://github.com/owine/claude-terminal-home-assistant/issues/320)) ([6d90a5c](https://github.com/owine/claude-terminal-home-assistant/commit/6d90a5c010da1fd34bf1a0619d445eed60b28b31))
...
* update all non-major dependencies ([#305](https://github.com/owine/claude-terminal-home-assistant/issues/305)) ([e16bdfc](https://github.com/owine/claude-terminal-home-assistant/commit/e16bdfc1c557370e2474d5e137d12067670397e5))
* update all non-major dependencies ([#307](https://github.com/owine/claude-terminal-home-assistant/issues/307)) ([ab09a12](https://github.com/owine/claude-terminal-home-assistant/commit/ab09a1257c04bac5dca153eaee04a79fc51670f5))
* update dependency alpine_3_24/python3 to v3.14.7-r1 ([#302](https://github.com/owine/claude-terminal-home-assistant/issues/302)) ([b1ad23c](https://github.com/owine/claude-terminal-home-assistant/commit/b1ad23cb0455efc1af4e063ffcc113af80208fec))
* update dependency alpine_3_24/tmux to v3.7c-r0 ([#308](https://github.com/owine/claude-terminal-home-assistant/issues/308)) ([0a4e371](https://github.com/owine/claude-terminal-home-assistant/commit/0a4e3716b08587a4089645088b39e584d0191323))
* update dependency eslint to v10.8.1 ([#299](https://github.com/owine/claude-terminal-home-assistant/issues/299)) ([cd94e13](https://github.com/owine/claude-terminal-home-assistant/commit/cd94e13978287527210b2f159e84e7aa2be639be))
...
* update all non-major dependencies ([#239](https://github.com/owine/claude-terminal-home-assistant/issues/239)) ([cfb5f12](https://github.com/owine/claude-terminal-home-assistant/commit/cfb5f120853a03d5c2ac1b8186c1004d0f3adf90))
* update all non-major dependencies ([#244](https://github.com/owine/claude-terminal-home-assistant/issues/244)) ([d40e0f5](https://github.com/owine/claude-terminal-home-assistant/commit/d40e0f597cf10d485adbc155c1a49edbdbd290a1))
* update all non-major dependencies ([#248](https://github.com/owine/claude-terminal-home-assistant/issues/248)) ([7956dbb](https://github.com/owine/claude-terminal-home-assistant/commit/7956dbb523178b993f328d68bc70bcc7a1ad23fe))

## [2.6.2](https://github.com/owine/claude-terminal-home-assistant/compare/v2.6.1...v2.6.2) (2026-07-13)


### Dependencies

* update all non-major dependencies ([#235](https://github.com/owine/claude-terminal-home-assistant/issues/235)) ([a0d553a](https://github.com/owine/claude-terminal-home-assistant/commit/a0d553a0f7879963377a369156d501c5213ad07e))
* update all non-major dependencies ([#238](https://github.com/owine/claude-terminal-home-assistant/issues/238)) ([2b96b60](https://github.com/owine/claude-terminal-home-assistant/commit/2b96b604cf36a3f18da075c5eecddcee8b5a83f9))
...
* update all non-major dependencies ([#210](https://github.com/owine/claude-terminal-home-assistant/issues/210)) ([ca93d61](https://github.com/owine/claude-terminal-home-assistant/commit/ca93d618b21fcd8128a0dddb85cc0b5dd1214163))
...
* lock file maintenance all non-major dependencies ([#176](https://github.com/owine/claude-terminal-home-assistant/issues/176)) ([9fe6f07](https://github.com/owine/claude-terminal-home-assistant/commit/9fe6f073dc670c17899ad29380c0a9c0fce85030))
* lock file maintenance all non-major dependencies ([#179](https://github.com/owine/claude-terminal-home-assistant/issues/179)) ([74d82b3](https://github.com/owine/claude-terminal-home-assistant/commit/74d82b37bd7856b1cc3cce986066422040360b7d))

## [2.4.2](https://github.com/owine/claude-terminal-home-assistant/compare/v2.4.1...v2.4.2) (2026-06-01)


### Bug Fixes

* update all non-major dependencies ([#171](https://github.com/owine/claude-terminal-home-assistant/issues/171)) ([b3f2759](https://github.com/owine/claude-terminal-home-assistant/commit/b3f27598becb47402a33fa2e75ddd9aebb6a5b17))


### Dependencies

* lock file maintenance ([#172](https://github.com/owine/claude-terminal-home-assistant/issues/172)) ([5cebf99](https://github.com/owine/claude-terminal-home-assistant/commit/5cebf99affe7b66d53a51864cbaece7ae3448ba9))

## [2.4.1](https://github.com/owine/claude-terminal-home-assistant/compare/v2.4.0...v2.4.1) (2026-05-25)


### Dependencies

* lock file maintenance ([#164](https://github.com/owine/claude-terminal-home-assistant/issues/164)) ([e34f7c5](https://github.com/owine/claude-terminal-home-assistant/commit/e34f7c5cc945edac385f3f731360567bf8421549))
* lock file maintenance ([#168](https://github.com/owine/claude-terminal-home-assistant/issues/168)) ([c598607](https://github.com/owine/claude-terminal-home-assistant/commit/c59860741fecb1237cf2755d52776ddf90ce394a))
...
* lock file maintenance ([#151](https://github.com/owine/claude-terminal-home-assistant/issues/151)) ([b558df4](https://github.com/owine/claude-terminal-home-assistant/commit/b558df4159a0a0a0e1086bec3ef387fdf618cdbc))
...
* lock file maintenance ([#124](https://github.com/owine/claude-terminal-home-assistant/issues/124)) ([304a163](https://github.com/owine/claude-terminal-home-assistant/commit/304a1634dcd86f3c975c7471504c3271aa139f2c))
* update all non-major dependencies ([#123](https://github.com/owine/claude-terminal-home-assistant/issues/123)) ([5be307f](https://github.com/owine/claude-terminal-home-assistant/commit/5be307f82051369c315bee287f3ced68a2e59b15))
...
* lock file maintenance ([#102](https://github.com/owine/claude-terminal-home-assistant/issues/102)) ([1ce8f41](https://github.com/owine/claude-terminal-home-assistant/commit/1ce8f4167ef8f00d9b7efee822a9c40588aae91a))
* update all non-major dependencies ([#100](https://github.com/owine/claude-terminal-home-assistant/issues/100)) ([56cc426](https://github.com/owine/claude-terminal-home-assistant/commit/56cc426acd842caf000775a1d2cf11aab8abe704))
* update dependency home-assistant/cli to v5 ([#101](https://github.com/owine/claude-terminal-home-assistant/issues/101)) ([20cc508](https://github.com/owine/claude-terminal-home-assistant/commit/20cc508b6c3aeb86634e46cd13ff27581d40f081))
